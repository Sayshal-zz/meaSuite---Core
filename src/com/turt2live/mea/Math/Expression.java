...
/**
 * 
 * Represents and resolves a mathematical formula. This class accepts expressions like '1+1' and '1*2'. It's also possible to use parenthesis, like '1+(8*2)' and '1*(5+5)'.
 * <p>
 * The formula can have spaces; this class cleans it before start parsing.
 * <p>
 * With this new implementation it's possible to use functions, defined by {@link Operator} enum.
 * <p>
 * To use, just put the name and the value inside parenthesis like 'cos(1)' 'sin(1)', etc..
 * <p>
 * With this, expressions can be complex, like '1-cos(8)+6*(tan(2)*log(1))'.
 * <p>
 * There's a especial operator 'random'. To use it: 'rnd(42)', this results in a value between 0 and 41.99.
 * 
...
public class Expression {
	...
	/**
	 * Creates an empty Expression. You need to use {@link #setExpression(String)} to assign a math expression string to.
	 */
	public Expression() {
		// do nothing
	}
	...
	/**
	 * Converts a string to a double or, if it's not possible, returns the value of the variable with the given name.
	 * 
	 * @param s
